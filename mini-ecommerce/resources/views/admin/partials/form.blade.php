            ...
            <form id="productForm" 
                ...
                <div class="space-y-4 sm:space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-2">
                            ...
                            <input id="productName" type="text" name="name" 
                                   class="py-2 px-3 block w-full border border-gray-200 shadow-sm rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500" 
                                   placeholder="{{ __('views.enter_product_name') }}" >
                            <div x-show="errors.name">
                                <p class="text-sm text-red-600 mt-2" x-text="errors.name[0]"></p>
                            </div>
                        </div>
                        <div class="space-y-2">
                            ...
                            <input id="productPrice" type="number" step="0.01" name="price" 
                                   class="py-2 px-3 block w-full border border-gray-200 shadow-sm rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500" 
                                   placeholder="{{ __('views.enter_price') }}" >
                            <div x-show="errors.price">
                                <p class="text-sm text-red-600 mt-2" x-text="errors.price[0]"></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div x-show="errors.image">
                            <p class="text-sm text-red-600 mt-2" x-text="errors.image[0]"></p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div x-show="errors.categories">
                            <p class="text-sm text-red-600 mt-2" x-text="errors.categories[0]"></p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div x-show="errors.description">
                            <p class="text-sm text-red-600 mt-2" x-text="errors.description[0]"></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-8 flex gap-x-2">
                    <button type="submit" id="submitBtn" 
                            class="py-2.5 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 transition-all shadow-sm disabled:opacity-50 disabled:pointer-events-none">
