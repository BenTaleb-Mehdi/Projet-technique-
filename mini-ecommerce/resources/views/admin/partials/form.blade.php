            ...
            <div class="pt-0 p-4 sm:pt-0 sm:p-7">
              <div class="space-y-4 sm:space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <input id="productName" type="text" name="name" class="py-1.5 sm:py-2 px-3 pe-11 block w-full border border-gray-200 shadow-2xs rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" placeholder="{{ __('views.enter_product_name') }}">
                </div>
                <div class="space-y-2">
                  ...
                  <input id="productPrice" type="number" step="0.01" name="price" class="py-1.5 sm:py-2 px-3 pe-11 block w-full border border-gray-200 shadow-2xs rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" placeholder="{{ __('views.enter_price') }}">
                </div>
                </div>
                ...
                <div class="space-y-2">
                  ...
                  <label for="af-submit-app-upload-images" class="group p-4 sm:p-7 block cursor-pointer text-center border-2 border-dashed border-gray-200 rounded-lg focus-within:outline-hidden focus-within:ring-2 focus-within:ring-blue-500 focus-within:ring-offset-2">
                    ...
                    <span class="mt-2 block text-sm text-gray-800">
                      {{ __('views.browse_device') }} <span class="group-hover:text-blue-700 text-blue-600">{{ __('views.drag_n_drop') }}</span>
                    </span>
                  ...
                  <div class="mt-4 hidden" id="previewContainer">
                      ...
                      <img id="imagePreview" src="" alt="{{ __('views.preview_alt') }}" class="w-full h-48 object-cover rounded-lg border border-gray-200">
                  </div>
                </div>
                ...
                <div class="space-y-2">
                  ...
                  <textarea id="productDescription" name="description" class="py-1.5 sm:py-2 px-3 block w-full border border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" rows="6" placeholder="{{ __('views.description_placeholder') }}"></textarea>
                </div>
              </div>
              <!-- End Grid -->
