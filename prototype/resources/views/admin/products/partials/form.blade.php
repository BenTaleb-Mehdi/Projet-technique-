                  ...
                  <div class="space-y-4 sm:space-y-6">
                    ...
                    <div class="space-y-2">
                      <label for="af-submit-app-project-name" class="inline-block text-sm font-medium text-gray-800 mt-2.5">
                        {{ __('views.admin.form.name_label') }}
                      </label>

                      <input id="af-submit-app-project-name" type="text" name="productName" class="py-1.5 sm:py-2 px-3 pe-11 block w-full border border-gray-200 shadow-2xs rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" placeholder="{{ __('views.admin.form.name_placeholder') }}">
                    </div>

                    <div class="space-y-2">
                      <label for="af-submit-project-url" class="inline-block text-sm font-medium text-gray-800 mt-2.5">
                        {{ __('views.admin.form.price_label') }}
                      </label>

                      <input id="af-submit-project-url" name="productPrice" type="text" class="py-1.5 sm:py-2 px-3 pe-11 block w-full border border-gray-200 shadow-2xs sm:text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" placeholder="{{ __('views.admin.form.price_placeholder') }}">
                    </div>

                    <div class="space-y-2">
                      <label for="af-submit-app-upload-images" class="inline-block text-sm font-medium text-gray-800 mt-2.5">
                        {{ __('views.admin.form.image_label') }}
                      </label>
                      ...
                      <label for="af-submit-app-upload-images" class="group p-4 sm:p-7 block cursor-pointer text-center border-2 border-dashed border border-gray-200 rounded-lg focus-within:outline-hidden focus-within:ring-2 focus-within:ring-blue-500 focus-within:ring-offset-2">
                        ...
                        <span class="mt-2 block text-sm text-gray-800">
                          {{ __('actions.browse') }} <span class="group-hover:text-blue-700 text-blue-600">{{ __('actions.drag_drop') }}</span>
                        </span>
                        <span class="mt-1 block text-xs text-gray-500">
                          {{ __('views.admin.form.file_size_limit') }}
                        </span>
                      </label>
                    </div>
                    ...
                    <div class="space-y-2">
                      <label for="af-submit-app-category" class="inline-block text-sm font-medium text-gray-800 mt-2.5">
                        {{ __('views.admin.form.category_label') }}
                      </label>
