    ...
    <div class="max-h-full overflow-hidden flex flex-col bg-white border border-gray-200 shadow-2xs rounded-xl pointer-events-auto">
      ...
      <div class="p-2 overflow-y-auto w-full">
          ...
          <div class="w-full sm:px-6 lg:px-8 lg:py-5 mx-auto">
            <form id="Formproduct" enctype="multipart/form-data" data-url="<?php echo e(route('products.store')); ?>">
              <?php echo csrf_field(); ?>
              <!-- Card -->
                ...
                <div class="pt-0 p-4 sm:pt-0 sm:p-7">
                  ...
                  <div class="space-y-4 sm:space-y-6">
                    ...
                    <div class="space-y-2">
                      ...
                      <input id="af-submit-app-project-name" type="text" name="productName" class="py-1.5 sm:py-2 px-3 pe-11 block w-full border border-gray-200 shadow-2xs rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" placeholder="product name">
                    </div>
                    ...
                    <div class="space-y-2">
                      ...
                      <input id="af-submit-project-url" name="productPrice" type="text" class="py-1.5 sm:py-2 px-3 pe-11 block w-full border border-gray-200 shadow-2xs sm:text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"  placeholder="product price">
                    </div>
                    ...
                    <div class="space-y-2">
                      ...
                      <label for="af-submit-app-upload-images" class="group p-4 sm:p-7 block cursor-pointer text-center border-2 border-dashed border border-gray-200 rounded-lg focus-within:outline-hidden focus-within:ring-2 focus-within:ring-blue-500 focus-within:ring-offset-2">
                       ...
                       <span class="group-hover:text-blue-700 text-blue-600">drag</span>
                        </span>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 5px; margin-bottom: 10px;">
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div style="display: flex; align-items: center; gap: 8px;">
                                ...
                                <label style="margin-top: 0;" for="<?php echo e($category->id); ?>">
                    ...
                    <div class="space-y-2">
                      ...
                      <textarea name="productDescription" id="af-submit-app-description" class="py-1.5 sm:py-2 px-3 block w-full border border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" rows="6" placeholder="<?php echo e(__('views.admin.form.description_placeholder')); ?>"></textarea>
                    </div>
                  </div>
                  <!-- End Grid -->
...
<?php /**PATH C:\GitHub\Projet technique\Projet-technique-\prototype_livecoding\resources\views/admin/partials/form.blade.php ENDPATH**/ ?>